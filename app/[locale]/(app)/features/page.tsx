...
const FEATURES = [
  ...
  { id: "groupShowcase", icon: Palette, accent: "from-sky-500 to-indigo-500", Mockup: GroupShowcaseMockup },
  { id: "groupContents", icon: Radio, accent: "from-fuchsia-500 to-rose-500", Mockup: GroupContentsMockup },

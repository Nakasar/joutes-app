...
import { CGU_LAST_UPDATED } from "@/lib/constants/legal.ts";
import { cguFr } from "./content.fr.tsx";
import { cguEn } from "./content.en.tsx";
...
async function getDocument() {
  ...
  return {
    ...
    formattedDate: await formatLegalDate(CGU_LAST_UPDATED, locale),
  };
}

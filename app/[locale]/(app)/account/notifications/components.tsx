...
import {updateNotificationsPreference} from "@/app/[locale]/(app)/account/actions.ts";
import type {NotificationChannel, NotificationPreferenceType} from "@/lib/notifications/preferences.ts";

...
import {NotificationPreferenceSwitch} from "@/app/[locale]/(app)/account/notifications/components.tsx";
import {PushDevicesSection} from "@/app/[locale]/(app)/account/notifications/PushDevicesSection.tsx";
...
async function AccountNotificationsPageContent() {
  ...
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-gradient-to-b from-background to-muted/20 py-8">
      <div className="container mx-auto px-4 max-w-5xl">
          <AccountPanelSkeleton cards={1} label="Chargement des préférences" />
        </div>
    </div>
      }
    >
      <AccountNotificationsPageContent />
    </Suspense>
  );
}

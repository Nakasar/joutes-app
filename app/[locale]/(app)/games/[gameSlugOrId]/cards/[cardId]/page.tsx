...
import CardSearchBar from "./CardSearchBar.tsx";
import CollectionManager from "./CollectionManager.tsx";
import AddToWishlistButton from "@/components/AddToWishlistButton.tsx";
import CardSocialOwnership, {type FriendOwnership, type PlayGroupOwnership} from "./CardSocialOwnership.tsx";
import db from "@/lib/mongodb.ts";
import {auth} from "@/lib/auth.ts";
import {headers} from "next/headers";
import {Metadata} from "next/types";
import {getErratasByCardId} from "@/lib/db/erratas.ts";
import {Button} from "@/components/ui/button.tsx";
import { Link } from "@/i18n/navigation.ts";
import BanCardButton from "@/app/[locale]/(app)/games/[gameSlugOrId]/cards/[cardId]/BanCardButton.tsx";
import EditErrataDialog from "@/components/EditErrataDialog.tsx";
import DeleteErrataButton from "@/components/DeleteErrataButton.tsx";
import ErrataVoteButtons from "@/components/ErrataVoteButtons.tsx";
...
import {getCardsByNames} from "@/lib/db/cards.ts";
import {getCardOwnershipByOwners, type CollectionOwner} from "@/lib/db/collection.ts";
import {getUserById, getUsersByIds, toPublicUser} from "@/lib/db/users.ts";
import {getPlayGroupsForUser} from "@/lib/db/play-groups.ts";
import {getWishlistIdsContainingCard} from "@/lib/db/wishlists.ts";
import {extractBracketedMentions} from "@/lib/errata-markdown.ts";
import {annotateCardText} from "@/lib/card-text-markdown.ts";
import GameMarkdown from "@/components/GameMarkdown.tsx";
import AnnotatedMarkdown from "@/components/AnnotatedMarkdown.tsx";
import CopyCardTextButton from "@/components/CopyCardTextButton.tsx";

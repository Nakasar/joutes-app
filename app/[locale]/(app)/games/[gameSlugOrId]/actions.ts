...
import {ErrataDb, ErrataTranslationInput, ErrataType, ErrataVoteType} from "@/lib/types/errata.ts";
...
import {
  ...
  deleteErrataById,
  voteOnErrata,
} from "@/lib/db/erratas.ts";
import {deleteReportsForContent} from "@/lib/db/reports.ts";

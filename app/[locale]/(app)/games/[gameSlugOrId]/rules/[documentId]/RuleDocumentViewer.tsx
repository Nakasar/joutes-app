...
import type {RuleTreeNode, RuleSection, SearchRuleEntry, RuleDocument, RuleLang} from '@/lib/rules/riftbound.ts';
import {KeywordBadge} from '@/components/games/KeywordBadge.tsx';

...
import {
  ...
  battleReportSchema,
  gameMatchSchema,
} from "@/lib/schemas/game-match.schema.ts";
import { GameMatch } from "@/lib/types/GameMatch.ts";
import { BattleMap, BattleReport, BattleReportArmy, GameMatchGuest } from "@/lib/types/Match.ts";
import { normalizeArmy, normalizeBattleReport } from "@/lib/battle-reports/army.ts";
import { normalizeBattleMap } from "@/lib/battle-reports/battle-map.ts";
import {
  MAX_GUESTS,
  isGuestId,
  isParticipant,
  normalizeGuests,
  participantIds,
} from "@/lib/matches/participants.ts";
import { searchGameProducts, type GameProductSummary } from "@/lib/db/products.ts";
import { gameIdSchema } from "@/lib/schemas/game.schema.ts";
import { getUserByUsernameAndDiscriminator, getUserById } from "@/lib/db/users.ts";
import { ObjectId } from "mongodb";
import db from "@/lib/mongodb.ts";
import { toggleWinner, voteMVP } from "@/lib/db/matches.ts";

...
import type { TournamentActivityType } from "@/lib/types/Tournament.ts";
...
const TONE: Record<TournamentActivityType, string> = {
  ...
  "match-forfeited": "bg-amber-500",
  "announcement-sent": "bg-sky-500",
  "round-created": "bg-sky-500",
  "round-deadline-set": "bg-sky-500",
  "round-closed-on-deadline": "bg-amber-500",

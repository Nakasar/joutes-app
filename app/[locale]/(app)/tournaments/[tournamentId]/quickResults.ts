import type { TournamentGameResult } from "@/lib/types/Tournament.ts";

// Un raccourci de saisie : le score en manches qu'il représente et les parties
// à envoyer à l'API pour l'obtenir.
...
/**
 * Raccourcis de saisie d'un duel, dérivés du best-of de la phase.
 *
...
/** Premier prénom (ou premier mot) d'un nom, pour tenir dans un bouton étroit. */

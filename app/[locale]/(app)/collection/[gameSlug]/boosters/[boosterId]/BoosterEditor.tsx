...
} from "@/lib/collection/ownership.ts";
import { getBoosterTypeOptions, normalizeBoosterType } from "@/lib/constants/booster-types.ts";
import { BOOSTER_NOTE_MAX_LENGTH } from "@/lib/constants/boosters.ts";
                  ...
                  >
                    ...
                    <div className="p-1.5">
                      <div className="flex min-w-0 items-start justify-between gap-1">
                        ...
                        <CardPriceTag price={card.marketPrice} gameSlug={gameSlug} className="text-[10px] leading-tight" />
                      </div>

          ...
          <Section className="bg-white m-0 w-full p-0 pt-[92px] mobile:pt-0">
            <Container className="bg-background mx-auto w-full max-w-[640px]">
              <Section className="mobile:px-6 px-[40px] pb-[80px]">
                ...
                <Text className="font-15 text-primary-foreground m-0 mt-[32px] max-w-[430px] font-sans">
                  Bonjour {props.username},
                </Text>
                <Text
                  className="font-15 text-foreground m-0 mt-[32px] max-w-[430px] font-sans"
                >
                ...
                <Text className="font-15 text-foreground m-0 mt-[32px] max-w-[430px] font-sans">
                  A bientôt sur Joutes !
                </Text>
              </Section>

              {/* Footer */}
              <Section className="mobile:px-6 border-stroke mt-8 border-t px-[40px] pt-[80px] pb-[64px]">
                <Text className="font-13 text-muted-foreground m-0 max-w-[320px] font-sans">
                  Joutes te tient informé-e des évènements de tes jeux dans tes communautés locales.
                </Text>
                <Row align="left">

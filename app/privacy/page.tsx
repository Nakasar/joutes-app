...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Politique de confidentialité - Joutes",
    description:
      "Comment Joutes collecte, utilise et protège vos données personnelles : données traitées, finalités, destinataires, durées de conservation et exercice de vos droits.",
  },
};
...
const ARTICLES: LegalArticle[] = [
    ...
    content: (
      <>
        ...
        <LegalList>
          ...
          <li>
            sessions actives : jeton de session, dates de création et d&apos;expiration, adresse IP
            et navigateur utilisés lors de la connexion.
          </li>
        </LegalList>
        <p>
        ...
        <LegalList>
          ...
          <li>jeux et lieux suivis, langue d&apos;affichage, thème, préférences de notifications.</li>
        </LegalList>
        <p>
        ...
        <LegalList>
          <li>
            une position par défaut (latitude et longitude) si vous choisissez de l&apos;enregistrer
            dans votre compte ;
          </li>
          <li>
        ...
        <LegalList>
          ...
          <li>
            amis et demandes d&apos;amis, lieux suivis, appartenance à des lieux privés ;
          </li>
          <li>
            collections, listes de souhaits, decks, cubes, échanges et listes de vente ;
          </li>
          <li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Chaque traitement répond à une finalité déterminée et repose sur une base légale au sens
          du RGPD :
        </p>
        <LegalTable
      ...
      <>
        ...
        <LegalList>
          ...
          <li>
            ...
            groupes de jeu et de vos lieux privés, ainsi que les participants et organisateurs des
            événements auxquels vous vous inscrivez.
          </li>
          <li>
            <strong>Privé par défaut :</strong> votre adresse email, votre position enregistrée,
            vos collections, listes de souhaits, decks et cubes, tant que vous ne les partagez pas.
          </li>
        </LegalList>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <LegalList>
          <li>
            <strong>Cookies strictement nécessaires :</strong> cookie de session permettant de vous
            maintenir connecté, cookie de langue (<code>NEXT_LOCALE</code>) et cookies techniques
            de sécurité.
          </li>
          <li>
            <strong>Stockage local :</strong> votre préférence de thème (clair, sombre ou système)
            est conservée dans votre navigateur et n&apos;est jamais transmise à nos serveurs.
          </li>
          <li>
            <strong>Mesure d&apos;audience :</strong> Vercel Web Analytics produit des statistiques
            agrégées de fréquentation sans déposer de cookie publicitaire, sans identifiant
            persistant et sans suivi entre sites.
          </li>
        </LegalList>
        <p>
    ...
    content: (
      <>
        ...
        <LegalTable
          ...
          rows={[
            ...
            [
              "MongoDB",
              "Base de données",
              "Comptes, profils, contenus et activité",
            ],
            [
              "Meilisearch",
            ...
            [
              "Resend",
              "Envoi des emails",
              "Adresse email et contenu du message envoyé",
            ],
            [
              "OpenAI",
        ...
        <p>
          ...
          applications que vous avez vous-même autorisées via OAuth ou vos clés d&apos;API, et aux
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <LegalList>
          <li>
            <strong>Scan de cartes :</strong> l&apos;image que vous photographiez est transmise au
            prestataire pour identifier la carte ; elle n&apos;est pas conservée sur nos serveurs.
          </li>
          <li>
            <strong>Vérification de decks :</strong> la liste de cartes soumise est transmise pour
            analyse.
          </li>
          <li>
    ...
    content: (
      <>
        ...
        <p>
          ...
          d&apos;engendrer un risque élevé pour vos droits et libertés, vous en serez informé dans
    ...
    content: (
      <>
        ...
        <LegalList>
          ...
          <li>
            <strong>Limitation :</strong> demander le gel temporaire d&apos;un traitement contesté ;
          </li>
          <li>
        ...
        <p>
          ...
          vous sera apportée dans un délai d&apos;un mois, prolongeable en cas de demande complexe.
          Nous pouvons être amenés à vérifier votre identité, notamment via l&apos;adresse email
    ...
    content: (
      <>
        <p>
          ...
          âge, la création d&apos;un compte suppose l&apos;accord du titulaire de l&apos;autorité
          parentale.
        </p>
        <p>
          Si vous constatez qu&apos;un compte a été créé par un enfant sans cet accord, contactez-nous :
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Cette politique peut évoluer avec les fonctionnalités de la Plateforme ou le cadre légal
          applicable. La date de dernière mise à jour figure en haut de la page.
        </p>
        <p>
  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8">
      <div className="space-y-8">
        <LegalHeader
          title="Politique de confidentialité"
          description="Quelles données Joutes collecte, pourquoi, avec qui elles sont partagées et comment garder la main dessus."
        ...
        <Card>
          ...
          <CardContent>
            <ul className="list-disc space-y-2 pl-6 text-sm text-muted-foreground">
              <li>
                Nous ne collectons que ce qui est nécessaire au fonctionnement de la Plateforme.
              </li>
              <li>
                Vos données ne sont ni vendues, ni louées, ni utilisées à des fins publicitaires.
              </li>
              <li>
                Aucun cookie publicitaire, aucun traceur de profilage : la mesure d&apos;audience
                est anonyme.
              </li>
              <li>
                Votre position n&apos;est utilisée que si vous la fournissez, pour trouver des
                événements proches de vous.
              </li>
              <li>
                Vous pouvez consulter, corriger, exporter ou faire supprimer vos données à tout
                moment.
              </li>
            </ul>
          </CardContent>

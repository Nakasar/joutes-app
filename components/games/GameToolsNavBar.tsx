  ...
  return (
    <>
      <div className="flex-row flex-wrap gap-2 justify-end hidden lg:flex">
        ...
        {game.features?.cubes && currentTab !== 'cubes' &&
          <Button variant="secondary" asChild>
            <Link href={`/games/${gameSlug}/cubes`} className="hover:underline">
              {t("cubes")}
            </Link>
          </Button>
        }
        ...
        {game.features?.cards && currentTab !== 'scanner' &&
          <Button variant="secondary" asChild>
            <Link href={`/games/${gameSlug}/scanner`} className="hover:underline">
              {t("scanner")}
            </Link>
          </Button>
        }
        {game.features?.products && currentTab !== 'products' &&
          <Button variant="secondary" asChild>
            <Link href={`/games/${gameSlug}/products`} className="hover:underline">
              {t("products")}
            </Link>
          </Button>
        }
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            ...
            {game.features?.products &&
              <DropdownMenuItem asChild>
                <Link href={`/games/${gameSlug}/products`}>
                  {t("products")}
                </Link>
              </DropdownMenuItem>
            }
            ...
            {game.features?.cards &&
              <DropdownMenuItem asChild>
                <Link href={`/games/${gameSlug}/scanner`}>
                  {t("scanner")}
                </Link>
              </DropdownMenuItem>
            }

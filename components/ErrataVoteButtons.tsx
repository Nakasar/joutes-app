...
import { voteErrata } from "@/app/[locale]/(app)/games/[gameSlugOrId]/actions";
...
export default function ErrataVoteButtons({
  ...
  errataId: string;
  votes: { positive: number; negative: number; userVote?: ErrataVoteType };
  userCanVote: boolean;
}) {
  const [isPending, startTransition] = useTransition();

  const handleVote = (vote: ErrataVoteType) => {
